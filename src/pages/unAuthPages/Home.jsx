  ...
  return (
    <div className='h-screen'>
      ...
      <div className="flex justify-between items-center mt-36 w-10/12 m-auto">
          ...
          {/* =========== Body Text =========== */}
        <div className="w-[70%]">
          <h1 className="font-bold uppercase text-7xl leading-normal">READY TO SERVE. <br />EXCELLENT HEALTH <br />CARE, CLOSE TO HOME</h1>
          <h3 className="text-xl w-7/12 mt-6 mb-8 leading-normal ">At vero eos et accusamus et iusto odio dignissimos ducimus qui  blanditiis praesentium voluptatum deleniti atque corrupti quos dolores  et quas.</h3>
          <div className="flex justify-start items-center gap-12">
            <div className="text-xl border-none px-10 py-4 rounded-xl font-medium cursor-pointer uppercase text-[#fff] bg-[#29E189]">Book Now</div>
            <div className="text-xl border border-[#29E189] px-10 py-4 font-medium rounded-xl uppercase cursor-pointer text-[#29E189] bg-[#fff]">Schedule Later</div>
          </div>
        </div>
        ...
        <div>
          <div className="relative">
            <img src={ellipse} alt="" className="absolute top-[14%] left-[2%] w-2/12 -z-10"/>
            <img src={circle} alt="" className="top-0 left-0 w-[100%] z-20"/>
            <img src={halfellipse} alt="" className="absolute bottom-[37%] -right-[5%] w-2/12 -z-10"/>
            <img src={wing} alt="" className="absolute top-[3%] left-[15%] w-8/12 z-10"/>
          </div>
        </div>
      </div>
      ...
      <div className="mt-60 p-10 bg-[#CAF2FF]">
        <div className="flex justify-between items-center gap-2 w-10/12 m-auto">
          <div className="w-6/12">
            ...
            <div className="my-12 text-xl leading-normal">Learn about different health conditions and how you can live a healthy life ...At vero eos et accusamus et iusto odio dignissimos ducimus qui  blanditiis praesentium voluptatum deleniti atque corrupti quos dolores  et quas.</div>
            <div className="px-10 py-4 uppercase text-[#fff] cursor-pointer border-none font-medium rounded-xl text-xl bg-[#29E189] w-max">Learn More</div>
          </div>
      ...
      <div className="mt-12 p-10 bg-[#FFCCFD]">
        <div className="w-8/12 m-auto flex justify-between items-center">
          <div className="flex flex-col justify-between items-center gap-4 text-center w-3/12">
            ...
            <div className="text-xl">Complete online registration to get in touch with our medical personnel.
            </div>
          </div>

          <div className="flex flex-col justify-between items-center gap-4 text-center w-3/12">
            <IoPersonOutline size={20} />
            <div className="text-xl">Have a virtual one on one session with our personnel regarding any medical issues.
            </div>
          </div>

          <div className="flex flex-col justify-between items-center gap-4 text-center w-3/12">
            <FaPen size={20} />
            <div className="text-xl">Get prescriptions or get referred to a laboratory for testing.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#CAF2FF]">
        <div className="flex justify-between items-center gap-4 w-10/12 m-auto py-3">
          <div className="flex justify-center items-center text-start">
            <span className="text-lg font-medium capitalize border-r border-[#D9D9D9] px-2">2023 Copyright:VirtuDoc</span>

            <span className="text-lg font-medium capitalize border-r border-[#D9D9D9] px-2">Site Map</span>

            <span className="text-lg font-medium capitalize border-r border-[#D9D9D9] px-2">Legal & Privacy</span>
